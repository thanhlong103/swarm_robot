...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Robot_message_member_array[5] = {
  {
    "robot_id",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(communication_msgs::msg::Robot, theta),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
