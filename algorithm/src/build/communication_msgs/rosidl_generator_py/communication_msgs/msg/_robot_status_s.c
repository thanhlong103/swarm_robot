...
bool communication_msgs__msg__robot_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("communication_msgs.msg._robot_status.RobotStatus", full_classname_dest, 48) == 0);
  }
  communication_msgs__msg__RobotStatus * ros_message = _ros_message;
  {  // robot_id
...
PyObject * communication_msgs__msg__robot_status__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("communication_msgs.msg._robot_status");
