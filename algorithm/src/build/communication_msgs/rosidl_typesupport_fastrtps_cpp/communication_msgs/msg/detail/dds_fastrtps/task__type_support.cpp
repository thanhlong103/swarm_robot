...
#include "communication_msgs/msg/detail/task__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const communication_msgs::msg::Task & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  communication_msgs::msg::Task & ros_message)
{
  // Member: task_id
  cdr >> ros_message.task_id;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = communication_msgs::msg::Task;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const communication_msgs::msg::Task *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<communication_msgs::msg::Task *>(
    untyped_ros_message);
...
{
  return &communication_msgs::msg::typesupport_fastrtps_cpp::_Task__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, communication_msgs, msg, Task)() {
  return &communication_msgs::msg::typesupport_fastrtps_cpp::_Task__handle;
}
