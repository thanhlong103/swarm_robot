...
#include "communication_msgs/msg/detail/robot__rosidl_typesupport_fastrtps_c.h"
...
using _Robot__ros_msg_type = communication_msgs__msg__Robot;
...
static uint32_t _Robot__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_communication_msgs__msg__Robot(
...
{
  return max_serialized_size_communication_msgs__msg__Robot(
    full_bounded, 0);
}
