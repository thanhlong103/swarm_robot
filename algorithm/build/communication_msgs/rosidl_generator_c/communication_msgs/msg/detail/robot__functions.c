...
communication_msgs__msg__Robot__create()
{
  ...
  communication_msgs__msg__Robot * msg = (communication_msgs__msg__Robot *)allocator.allocate(sizeof(communication_msgs__msg__Robot), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(communication_msgs__msg__Robot));
  bool success = communication_msgs__msg__Robot__init(msg);
  if (!success) {
...
communication_msgs__msg__Robot__destroy(communication_msgs__msg__Robot * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    communication_msgs__msg__Robot__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
communication_msgs__msg__Robot__Sequence__init(communication_msgs__msg__Robot__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  communication_msgs__msg__Robot * data = NULL;

  if (size) {
    data = (communication_msgs__msg__Robot *)allocator.zero_allocate(size, sizeof(communication_msgs__msg__Robot), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = communication_msgs__msg__Robot__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        communication_msgs__msg__Robot__fini(&data[i - 1]);
      }
...
communication_msgs__msg__Robot__Sequence__fini(communication_msgs__msg__Robot__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      communication_msgs__msg__Robot__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  communication_msgs__msg__Robot__Sequence * array = (communication_msgs__msg__Robot__Sequence *)allocator.allocate(sizeof(communication_msgs__msg__Robot__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = communication_msgs__msg__Robot__Sequence__init(array, size);
  if (!success) {
...
communication_msgs__msg__Robot__Sequence__destroy(communication_msgs__msg__Robot__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    communication_msgs__msg__Robot__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
communication_msgs__msg__Robot__Sequence__are_equal(const communication_msgs__msg__Robot__Sequence * lhs, const communication_msgs__msg__Robot__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!communication_msgs__msg__Robot__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  communication_msgs__msg__Robot__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(communication_msgs__msg__Robot);
    communication_msgs__msg__Robot * data =
      (communication_msgs__msg__Robot *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!communication_msgs__msg__Robot__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          communication_msgs__msg__Robot__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!communication_msgs__msg__Robot__copy(
